...
## 팀원 소개
팀원	학번	담당 역할
김효림 (팀장)	20221549	제어 스키마 설계 및 Control Service 구축, 커스텀 RL 환경 구현, PPO/SAC 학습 파이프라인 구현 및 베이스라인 평가 프레임워크 구축
심하연	20221573	MSA 설계 및 Docker 환경 구성, Streamlit 대시보드 프론트엔드 구현 및 API 연동, RL 학습 과 커스텀 보상 함수 보완
김다은	20231515	Forecast Service 스키마 설계 및 구축, LightGBM 기반 IT 부하·냉각 수요 예측 모델 구현
김성현	20201564	열역학 모델 구현 및 검증, PID 시뮬레이터 구현, 데이터 물리학적 검증
심서연	20221571	데이터 수집 및 전처리 (Google Cluster Trace 2019, 기상청 날씨, SPEC), 데이터 파이프라인을 구축해 파생변수 생성, 프로젝트 Git 관리